...
clear_all_ram:
    ...
    ld de, end_of_ram
    ld bc, (#c000 - 4) - end_of_ram  ; leave 2 bytes for the stack when calling "fw_caaf_clear_memory"
    call fw_caaf_clear_memory
    ld de, #c000
    ld bc, #4000
    jp fw_caaf_clear_memory
...
;------------------------------------------------------------------------
; RAM:
    include "dsk-v0/paketdsk-ram.asm"
